...
class Responses(LoginRequiredMixin, ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        global title
        """
        Если пользователь перешел на страницу через ссылку из письма 
        (ID поста) - фильтр работает по этому ID
        """
    ...
    def post(self, request, *args, **kwargs):
        ...
        """
        При событии POST (в пути открытой страницы есть ID) - нужно перезайти без этого ID
